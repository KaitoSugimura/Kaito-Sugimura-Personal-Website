...
export default function SelectedView({ index, sectionRatio }) {
  ...
  const videoId = Contents[index] && Contents[index].youtubeID;
  const extraImages = Contents[index] && Contents[index].extraImages;
    ...
    <>
      ...
      >
        ...
        <div className={styles.id}>
          <span>
            0{index}
            {Contents[index] && <h1>{Contents[index].title}</h1>}
          </span>
        </div>
      </div>
    </>
