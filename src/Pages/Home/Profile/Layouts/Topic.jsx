...
export default function Topic({ title, subtitle, topic, img, list }) {
  return (
    <div div className={styles.TopicRoot} key={title}>
      ...
      <div className={styles.whiteSquare}>
        ...
        <ul className={styles.list}>
          {list &&
            list.map((item, index) => <li className={styles.listItem}
            style={{
